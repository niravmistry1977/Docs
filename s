...
This letter serves to confirm that Mr. Nirav Kamleshbhai Mistry was employed full-time by Apex Technologies Group, Inc. in Edison, New Jersey from July 13, 2012 to January 4, 2019 as a Java Programmer. 

Mr. Mistry’s employment with Apex Technologies Group, Inc. was progressively responsible in that he was accorded greater responsibility and authority over assigned duties during the duration of his employment with our company. Throughout his employment, Mr. Mistry gained engineering experience including development and support of large (3500+) enterprise Linux servers (including Redhat, AIX and Solaris) and Windows (2008 or 2012) servers platform; executing shell scripting (korn or bash); with application web hosting platforms (Tomcat, WebLogic, JBoss or WebSphere); with UNIX to Active Directory Bridging services (Centrify Authentication Services); building and supporting the Privilege Access Management (PAM) solutions; writing PowerShell and batch shell scripts; writing MS SQL queries and reporting; and developing and writing Java and Java scripts.
...
In addition, Mr. Mistry implemented restful web services with security header handle request from front end authenticated user request; managed agent based opswise scheduler on large scaled all Unix environments, including Redhat, AIX, Solaris, installed agents and managed licenses on all Servers and used Powershell scripts; used MS Visio to create data flow diagrams to support documents that contained the essential business elements and detailed definitions; participated in daily stand ups to report daily tasks and achievements as well as identified any impediments for the project’s progress; managed all SDLC documents using Sharepoint to centralize the documents storage and collaborated with all team members; implemented CA IDP Portal Workflow and Taskflow to provision and deprovision user access using CA IAM and CA IAM Tools; implemented Federated Identity access with various enterprise based organization and trust security via secured encrypted protocols; integrated and managed Change Management / Incident management /Problem management systems HPSM and Service now with CMDB, PAM and Centrify system; and analyzed and coordinated business activities and operational resources for various large scale projects using business analysis, systems analysis, BRD, FRD, Agile, SharePoint, Visio, QC and MS Project.

My name is Sarvesh Kumar Dharayan and I serve as President of Apex Technologies Group, Inc. This position enables me to accurately comment on Mr. Mistry’s employment with Apex Technologies Group, Inc. during the abovementioned period. 

Should you require any further information pertaining to Mr. Mistry’s employment, please do not hesitate to contact me directly. 
